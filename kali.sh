...
if [ $quest = Y ]; then
	...
	if which polybar >/dev/null; then
		...
		chmod +x ${LOCALPATH}/.config/polybar/scripts/checkupdates
		chmod +x ${LOCALPATH}/.config/polybar/scripts/color-switch.sh
		chmod +x ${LOCALPATH}/.config/polybar/scripts/colors-dark.sh
		chmod +x ${LOCALPATH}/.config/polybar/scripts/colors-light.sh
		chmod +x ${LOCALPATH}/.config/polybar/scripts/launcher.sh
		chmod +x ${LOCALPATH}/.config/polybar/scripts/powermenu.sh
		chmod +x ${LOCALPATH}/.config/polybar/scripts/pywal.sh
		chmod +x ${LOCALPATH}/.config/polybar/scripts/random.sh
		chmod +x ${LOCALPATH}/.config/polybar/scripts/script-manager.sh
		chmod +x ${LOCALPATH}/.config/polybar/scripts/style-switch.sh
		chmod +x ${LOCALPATH}/.config/polybar/scripts/styles.sh
		chmod +x ${LOCALPATH}/.config/polybar/scripts/updates.sh
	else
		echo ""
