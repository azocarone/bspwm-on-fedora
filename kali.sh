...
if [ $quest = Y ]; then
	...
	if which polybar >/dev/null; then
		...
		rm -rf /root/scripts/shell-color-scripts/colorscripts
                ...
                cd /root/scripts
		mv colorscripts colorscript.sh /root/scripts/shell-color-scripts
		chmod +x /root/scripts/shell-color-scripts/colorscript.sh
		cd /root/scripts/shell-color-scripts/colorscripts
		chmod +x *
		cd /root
		echo ""
